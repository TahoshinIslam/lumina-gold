...
function SheetContent({
  ...
  // Slide only — no opacity fade. A translucent panel mid-slide lets the page
  // behind bleed through, which reads as two overlapping screens; keeping the
  // content fully opaque means the solid drawer background always masks it.
