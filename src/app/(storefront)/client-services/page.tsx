...
export const metadata: Metadata = {
  title: 'Client Services — Nahar Jewellers',
  description: 'Complimentary engraving, resizing, cleaning, repairs and lifetime care for every Nahar Jewellers creation.',
};
...
const SERVICES = [
  ...
  { title: 'Care & Cleaning', body: 'Complimentary lifetime cleaning and inspection for Nahar Jewellers pieces.' },
