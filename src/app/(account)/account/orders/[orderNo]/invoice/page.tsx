...
/**
 * The invoice (Phase 6) — A4, print-first.
 *
 ...
 */
export default async function Invoice({ params }: { params: Promise<{ orderNo: string }> }) {
  const { orderNo } = await params;
  ...
  return (
    <div className="inv-root">
      <div className="inv-bar">
        <a href={`/account/orders/${order.order_no}`} className="inv-back">← Back to order</a>
        <PrintButton />
      </div>
